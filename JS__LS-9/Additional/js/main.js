...
function usersBlocks(arr) {
    for (const user of arr) {
        let userContainer = document.createElement('div');
        userContainer.style.padding = '10px';
        userContainer.style.margin = '10px auto';
        userContainer.style.border = '2px solid';
        userContainer.style.width = '30%';
        userContainer.style.listStyle = 'none';
        userContainer.style.fontSize = '18px';
        userObject(user, userContainer);
