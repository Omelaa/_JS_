...
//     userName.innerText = `${item.name} ${item.surname}`;
//     let userAge = document.createElement('span');
//     userAge.innerText = `${item.age}`;
//     let userInfo = document.createElement('p');
//     userInfo.innerText = `${item.info}`;
//     let userImg = document.createElement('img');
//     userImg.src = `${item.photo}`;
//
//     divMember.append(userName, userAge, userInfo, userImg);
...
//     itemNum.innerText = `${item.monthDuration} ${item.hourDuration}`;
//     let itemList = document.createElement('ul');
//
//     for (const module of item.modules) {
//         let moduleItem = document.createElement('li');
//         moduleItem.innerText = `${module}`;
//         itemList.appendChild(moduleItem);
//     }
//
//     div.append(h3, itemNum, itemList);
