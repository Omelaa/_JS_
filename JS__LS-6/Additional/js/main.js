...
// let validator = (str) => {
//     let arr;
//     arr = str.toLowerCase().endsWith('@gmail.com') + str.endsWith('@email.com');
//     if (str === ('@gmail.com' || '@email.com')) {
//         return false
//     }
//     return arr;
// };
...
// }
//
// document.write(count("Астрономия это наука о небесных объектах", "о"));
...
// let count = (str, n) => str.split(' ').splice(0, n).join().replaceAll(',', ' ');
//
// document.write(count("Сила тяжести приложена к центру масс тела", 5));